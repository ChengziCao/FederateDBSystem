package com.suda.federate.sql.table;

import com.google.common.collect.ImmutableList;
import com.suda.federate.sql.schema.FederateSchema;
...
public abstract class FederateTable extends AbstractQueryableTable implements TranslatableTable {
  ...
  FederateTable(String tableName, FederateSchema schema, RelProtoDataType protoRowType) {
    super(Object[].class);
